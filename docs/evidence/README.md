...
| `final-demo-page.jpg` | Bonus demo page at `/` shortening a real URL (Open / Copy / Clicks controls) |
| `final-demo-blocked.jpg` | Demo page: `javascript:` scheme rejected by the ADR-004 security validation (400) |
| `final-demo-ratelimit.jpg` | Demo page: 21st create in a minute hitting the per-IP rate limit (429) |
